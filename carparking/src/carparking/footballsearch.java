...
public class footballsearch extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					footballsearch frame = new footballsearch();
...
//					System.out.println(date);
					...
					String query="select Name,fromm,tooo,mobile,Date,roll,tablee from football where Date = '"+ date +"' ";
