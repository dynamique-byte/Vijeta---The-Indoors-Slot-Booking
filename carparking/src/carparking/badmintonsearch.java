...
public class badmintonsearch extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					badmintonsearch frame = new badmintonsearch();
...
//					System.out.println(date);
					...
					String query="select Name,fromm,tooo,mobile,Date,roll,tablee from badminton where Date = '"+ date +"' ";
		...
		JLabel lblNewLabel_1 = new JLabel("pppiui");
