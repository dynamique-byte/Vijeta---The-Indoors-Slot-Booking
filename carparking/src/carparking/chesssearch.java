...
public class chesssearch extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					chesssearch frame = new chesssearch();
...
//					System.out.println(date);
					...
					String query="select Name,fromm,tooo,mobile,Date,roll,tablee from chess where Date = '"+ date +"' ";
